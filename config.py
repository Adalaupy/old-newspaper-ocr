...
OCR_MISTRAL_REQUEST_DOCUMENT_ANNOTATION = True  # Prefer structured transcription over markdown fallback
OCR_MISTRAL_APPLY_PYCORRECTOR = False  # Keep Mistral output closer to the model's original transcription
OCR_MISTRAL_STRICT_TRANSCRIPTION = True  # Tell Mistral to preserve wording, order, and line breaks exactly
OCR_MISTRAL_CLEAN_MARKDOWN_FALLBACK = True  # Strip markdown list/header markers if structured text is unavailable
